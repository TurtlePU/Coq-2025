...
Ltac check_type A B :=
    ...
    | context[MISSING] => idtac "Не хватает:" A
    | ?T => first [unify T B; idtac "Тип: ok" | idtac "Тип: не тот - должен быть (" B ")"]
    end.
...
Ltac print_manual_grade A :=
    ...
    | Some (_ ?S ?C) =>
        ...
        match eval compute in C with
          | ""%string => idtac "Комментарий: нету"
          | _ => idtac "Комментарий:" C
        end
    | None =>
        idtac "Балл: не оценивается";
        idtac "Комментарий: нету"
    end.
...
idtac "#> Оценивается вручную: NatList.add_inc_count".
idtac "Максимум баллов: 2".
...
idtac "#> Оценивается вручную: Exercises.fold_map".
idtac "Максимум баллов: 3".
...
idtac "#> Оценивается вручную: Exercises.informal_proof".
idtac "Продвинутое".
idtac "Максимум баллов: 2".
...
idtac "Макс. баллов - стандартные: 40".
idtac "Макс. баллов - с продвинутыми: 66".
idtac "".
